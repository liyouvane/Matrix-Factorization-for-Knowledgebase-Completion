...
void input()
{
    FILE *fp1=fopen("/WN18/m3train.dat","r");
    FILE *fp2=fopen("/WN18/m3valid.dat","r");
    FILE *fp3=fopen("/WN18/m3test.dat","r");
    for(long i=1;i<=F;i++)
